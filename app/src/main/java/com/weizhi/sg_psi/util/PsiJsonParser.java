package com.weizhi.sg_psi.util;

import android.support.annotation.NonNull;

import com.weizhi.sg_psi.data.RegionInfo;
import com.weizhi.sg_psi.network.response.ItemsJson;
import com.weizhi.sg_psi.network.response.PsiJson;
import com.weizhi.sg_psi.network.response.ReadingsJson;
import com.weizhi.sg_psi.network.response.RegionMetadataJson;
